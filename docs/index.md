...
8. [Agent Authoring Guide](modules/agents.zh-en.md)
9. [Runtime Run and Worker Guide](guides/runtime-run-worker.zh-en.md)
10. [API Changelog](reference/api-changelog.zh-en.md)
11. [Deployment and Operations Guide](operations/deployment-operations.zh-en.md)
12. [Testing Playbook](guides/testing-playbook.zh-en.md)
13. [Architecture Roadmap](reference/architecture-roadmap.zh-en.md)
14. [Node 01: Project and Members](nodes/01-project-and-members.zh-en.md)
15. [Node 02: Resource and Registry](nodes/02-resource-and-registry.zh-en.md)
16. [Node 03: Chat and Runtime](nodes/03-chat-and-runtime.zh-en.md)
17. [Node 04: Memory System](nodes/04-memory-system.zh-en.md)
18. [Node 05: Provider Layer](nodes/05-provider-layer.zh-en.md)
19. [Node 06: Database and Migrations](nodes/06-database-and-migrations.zh-en.md)
20. [External Resources Integration](guides/external-resources-integration.zh-en.md)
